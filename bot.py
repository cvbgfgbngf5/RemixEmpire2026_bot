...
# Keyboard اصلی (دقیقاً ۳ دکمه کاملاً در ردیف‌های جدا - هر دکمه روی یک خط)
channel_btn = InlineKeyboardButton("𝑹𝒆𝒆𝒎𝒙 𝑬𝒆𝒆𝒆𝒎𝒑𝒊𝒓𝒆 🎧👑 | امپراتوری ریمیکس", url="https://t.me/RemixEmpire2026")
